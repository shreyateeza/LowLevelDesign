...
public class Student {
    ...
    public static class Builder{
        ...
        private void validate(){
            if(this.gradYear > 2023) throw new GradYearInvalidException();
            if(this.name == null) throw new InvalidNameException();
            if(this.age < 18) throw new InvalidAgeException();
        }

        public Student build(){
            validate();
            return new Student(1, "Shreya", "NSUT", 2020, 100, 25, "9898989898");
        }
